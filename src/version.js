...
export const VERSION_HISTORY = [
  {
    ...
    notes: [
      ...
      "③【顺手挖出两把永远刷不出的红档神兵】加「键的两截必须真实存在」守卫时当场抓到：「雪山派·雪山崖底」——雪山崖底其实在**顶峰**不在雪山派；「贡措海·令狐冲墓」——该房间早已并入**前辈墓地**。两条键都指向不存在的房间，于是 **霜天月**（呼延大侠的佩剑）与 **地藏**（桑杰大侠的刀）这两把红档，玩家走到崖底/墓地也永远看不见。这是个躺了很久的哑 bug——不报错，只是东西不出现。",
