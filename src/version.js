...
export const VERSION_HISTORY = [
  ...
  },
  {
    ...
    notes: [
      ...
      "③【左下角换成终端】视觉照 TraceViewer 抄（#0a0c10 底、#9a9a8a 字、#8ac8b8 高亮、等宽、pre-wrap），带时间戳与符号分级（▸开始 ✓成功 ✕失败 ↻重试 ⧗等额度）。日志提到主组件累积，所以扫描时与审改时看的是同一份，右上角可放大成 760px 浮层。替掉了原来那行「实调 N 次」——那只有结果没有过程，而 5 次/分钟的额度下最需要看见的是「现在卡在哪、为什么等、哪一批降级了」。",
