...
　　墙上挂着一件备用弟子服，浆洗得发白。窗纸破了个小口，风从那儿钻进来，冬天格外精神。`,
        exits: { w: "弟子别院" },
        buildingId: "chest_bieyuan",
        unlockCondition: { type: "item", itemName: "雪山派令牌钥匙" },
      },
      西厢书房: {
        x: -1, y: -3,
        desc: `　　一张旧书案，笔墨齐备，砚台里的墨干成了一块。架上几本心法杂书，翻开全是前人批注，字迹一层压一层。
　　窗下另有一张琴桌，桌上一张七弦琴，弦断了三根，剩下四根还绷着。没人修，也没人说要修。屋角一方小灶，灶膛松柴常年不熄——何雨谢偶尔在此给弟子炖雪鸡汤。`,
        exits: { e: "弟子别院" },
        buildingId: "kitchen_bieyuan",
        unlockCondition: { type: "item", itemName: "雪山派令牌钥匙" },
      },
      呼延雪居所: {
        x: -1, y: -2,
