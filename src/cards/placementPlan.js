...
【三种落脚方式，按人物性质选一种】
- mention 不落地：他的设定只在被提到时注入，不会出现在任何据点。适合远方的人、已死的人、传闻里的人、跨时代或跨世界观进不来的人。**拿不准就选这个**，凭空塞一个人进某个据点比不塞更破坏世界。
- resident 驻场：进了那个据点必定遇见他。适合有固定职守的人——掌柜、住持、门派长老、看守、坐堂的大夫。要给一个 district。
- wander 游走：按权重随机出现在若干据点，且只在设定时辰里露面。适合行商、镖师、游方僧、赏金客、四处找人的人。要给 weights。
...
4. 判断依据 why 写一句话，二十字以内，说清是根据人物的什么定的。玩家要靠它判断你有没有瞎猜。
